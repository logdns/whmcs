...
<html lang="en">
  <head>
    ...
    {/if}
    <link href="../templates/logdns/css/bootstrap.css" rel="stylesheet">
    <link href="../templates/logdns/css/whmcs.css" rel="stylesheet">

    <script src="../templates/logdns/js/whmcs.js"></script>
...
<div id="whmcsheader">
    <div class="whmcscontainer">
        ...
        <div id="whmcsimglogo"><a href="index.php"><img src="templates/{$template}/img/logo.png" alt="{$companyname}" /></a></div>
    </div>
</div>
